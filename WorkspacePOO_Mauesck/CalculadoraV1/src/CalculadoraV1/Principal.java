...
public class Principal {
	...
	public static void main(String[] args) {
		...
		do {
			//Solicita o 1º e 2º número.
			double num1 = solicitaNumero("1º");
			double num2 = solicitaNumero("2º");
			
			//A var "operacao" recebe o número inteiro que representa a operação escolhida no método "solicitaOperacao()".
			...
			case 4: 
				...
				break;
			default:
				JOptionPane.showMessageDialog(null, "Operação invalida! A calculadora sera encerrada");
				System.exit(0);
			}
